...
| 3 | DeepFilterNet comparison | Build an adapter behind NoiseSuppressionEngine. Review exact code/model licenses and pinned artifacts. Compare CPU, memory, measured latency and speech quality against RNNoise on the same authorized corpus. Ship no silent model download. |
